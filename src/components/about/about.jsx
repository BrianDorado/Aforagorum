        ...
        return (
            <div>
               ...
               <section className="about-text">
                ...
                <p>Figure it out, tutorials are for noobs
                    <br/>
               ...
               <section className='about-text'>
                   ...
                   <p>In its current state this app is just a test of some basic functionality. There are many things 
                       ...
                       <br/> In the future I 
                       <br/>
                       <br/> You can find a list of all functionality being worked on currently and upcoming <a href="http://">here</a>. 
                       There will also be a changelog you can view. 
                   </p>
               </section>
               <br/>
            </div>
